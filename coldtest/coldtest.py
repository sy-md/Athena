...
# Load the CSV data
data = pd.read_csv('Cold_Testing_Without_internet.csv', sep=",")
data2 = pd.read_csv('Cold_Testing_40C_W_internet.csv', sep=",")
...
fig.add_trace( 
    go.Scatter(x=data['Time'], y=bluetooth_temp["12Temp_bt_d1"], mode='lines'),
    row=1, col=1)
